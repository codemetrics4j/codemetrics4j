package org.codemetrics4j.metrics.value;
...
public class NumericValueSummaryStatistics {
    ...
    public static void accumulate(
            NumericValueSummaryStatistics numericValueSummaryStatistics, NumericValue numericValue) {
    ...
    public static NumericValueSummaryStatistics combine(
            NumericValueSummaryStatistics left, NumericValueSummaryStatistics right) {
