...
public class SpecializationIndexCalculator implements Calculator<Type> {
    ...
    private Pair<Integer, Integer> calculateOverloadedAndInheritedOperations(Type type) {
        ...
        Set<Triple<com.github.javaparser.ast.type.Type, String, List<com.github.javaparser.ast.type.Type>>>
                parentMethods = new HashSet<>();
        ...
        while (!typesToCheck.empty()) {
            ...
            for (Method method : typeToCheck.getMethods()) {
                Triple<com.github.javaparser.ast.type.Type, String, List<com.github.javaparser.ast.type.Type>>
                        methodSignature = getMethodSignatureData(method);
        ...
        for (Method m : type.getMethods()) {
            ...
            Triple<com.github.javaparser.ast.type.Type, String, List<com.github.javaparser.ast.type.Type>>
                    methodSignature = getMethodSignatureData(m);
    ...
    private Triple<com.github.javaparser.ast.type.Type, String, List<com.github.javaparser.ast.type.Type>>
            getMethodSignatureData(Method method) {
